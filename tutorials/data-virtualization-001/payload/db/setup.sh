...
__loadIFMXDocker()
{
   ...
   if [[ ! `docker images --quiet ibmcom/informix-developer-database:latest` ]]; then
        ...
        $D run -d -it --name $IFMX_DOCKER_NAME -p 9088:9088 -p 9089:9089 -p 27018:27018 -p 27883:27883 -e LICENSE=accept -e SIZE=small ibmcom/informix-developer-database:latest
